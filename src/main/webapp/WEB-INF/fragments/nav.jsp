...
<fmt:setLocale value="${param.language != null ? param.language : sessionScope.language != null ? sessionScope.language : 'en'}" />
        ...
        <div class="flex justify-between items-center min-w-80">
            ...
            <form action="" method="get" class="inline">
                <select name="language" onchange="this.form.submit()" class="bg-white text-black border border-gray-300 rounded-md p-2">
                    <option value="en" ${param.language == 'en' || sessionScope.language == 'en' ? 'selected' : ''}>English</option>
                    <option value="es" ${param.language == 'es' || sessionScope.language == 'es' ? 'selected' : ''}>Español</option>
                </select>
